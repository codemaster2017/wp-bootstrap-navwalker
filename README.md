...
If you would like to use **Bootstrap 2.x** you can find the legacy version of the walker class here https://github.com/codemaster2017/wp-bootstrap-navwalker/tree/For-Bootstrap-2.3.2
...
Installation
------------
Place **wp-bootstrap-navlist-walker.php** in your WordPress theme folder `/wp-content/your-theme/`
